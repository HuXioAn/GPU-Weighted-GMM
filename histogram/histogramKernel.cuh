...
template<typename histogramTypeIn, typename histogramTypeOut, typename particleHistogramCUDA>
 __global__ void histogramKernel2D(const int nop, const histogramTypeIn *d1, const histogramTypeIn *d2, 
                                    const histogramTypeIn *q, particleHistogramCUDA *histogramCUDAPtr)
{
 ...
 */
template<typename particleHistogramCUDA>
__global__ void resetBinKernel(particleHistogramCUDA* histogramCUDAPtr){
